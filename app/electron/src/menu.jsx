...
if (process.platform === 'darwin') {
    ...
    // Window menu.
    applicationMenuTemplate[3].submenu.push(
        { type: 'separator' },
        {
    ...
    addUpdateMenuItems(applicationMenuTemplate[0].submenu, 1)
}

if (process.platform === 'win32') {
    const helpMenu = applicationMenuTemplate[applicationMenuTemplate.length - 1].submenu
